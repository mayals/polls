...
def poll_share_by_email(request,poll_slug,year,month,day):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            subject = f"{sender_name} recommends you vote of {poll.poll_question}"
            ...
            messages.success(request,f'Thanks ( {sender_name} ), for sharing the post.')
            ...
            form = SharePollByEmailForm()
            messages.error(request,f'The post not shared! please try again')
