...
from .forms import RoleSelectForm, UserRegisterForm, UserLoginForm, AdminProfileUpdateForm, OwnerProfileUpdateForm, VoterProfileUpdateForm,UserRegisterUpdateForm
...
def my_profile_update(request):
    user= request.user
    userform = UserRegisterUpdateForm(instance=user)
    ...
    if request.user.role  == 'ADMIN' :       
        ...
        if request.method == 'POST' :
            ...
            userform = UserRegisterUpdateForm(request.POST, request.FILES, instance=user)
